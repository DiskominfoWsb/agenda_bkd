      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav navbar-right">	
			...
			<li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-file icon-white"> </i> Sekret<span class="caret"></span></a>
...
<br><br>
	  ...
	  <div class="span12 well well-sm">
		<h5 style="font-weight: bold">e-Agenda by <a href="http://bkd.wonosobokab.go.id" target="_blank"> <?=base64_decode($this->config->item('twoo'))?></a></h5>
