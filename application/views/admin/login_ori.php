    ...
    <div class="navbar navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header">
          <span class="navbar-brand"><strong style="font-family: verdana; margin-left: -50px; font-size: 24px;color:#ffffff;"><i>e-Agenda</i> </strong>Badan Kepegawaian Daerah</span>
		  <span>
...
<!--    Available colors for the full background: full-color-blue, full-color-azure, full-color-green, full-color-red, full-color-orange
    ...
    <thead>
		...
		<tr>
			<th width="40%">Hari / Tanggal</th>
			<th width="15%">Acara / Kegiatan</th>
			<th width="15%">Jam</th>
...
<div class="row">
  <div class="col-md-12 col-md-offset-0">
    <center style="margin-top: -15px;">&copy; <a href="">2021</a> |<a href="http://bkd.wonosobokab.go.id">Badan Kepegawaian Daerah Kab.Wonosobo</a>
	</center>
	</div>
</div>	
</div>	
