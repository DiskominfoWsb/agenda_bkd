...
<form action="<?=base_URL()?>admin/cetak_agenda_excel" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
	...
	<tr><td colspan="2">
	<br>
	<button type="submit" class="btn btn-primary btn-sm">Cetak Excel</button>
