...
<form action="<?=base_URL()?>admin/cetak_toExcelAll" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	<input type="hidden" name="tipe3" value="<?php echo $this->uri->segment(2); ?>">
